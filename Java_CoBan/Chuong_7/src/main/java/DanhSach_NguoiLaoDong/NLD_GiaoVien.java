...
public class NLD_GiaoVien extends NguoiLaoDong{
    ...
    public NLD_GiaoVien( String hoTen, Ngay ngaySinh, Ngay ngayVaoLam, double heSoLuong,int soGioVuot, int tienGioVuot) {
        super(hoTen, ngaySinh, ngayVaoLam, heSoLuong);
